...
- The trust-floor change (PR #14 WU4) is a clean break, not additive — verify this before assuming any org-repo `OWNER`-based logic still exists anywhere in `git-common.sh`.
